...
class Db
{
    ...
    public function __construct($st_database) {
        ...
        // Get Server for read
        // TODO: Create an algorith to support more servers
        ...
        if (isset($st_database['write']['servers'][0]['client_encoding'])) {
            $this->s_connection_client_encoding_read = $st_database['write']['servers'][0]['client_encoding'];
        }
    ...
    public function queryWrite($s_sql) {
        ...
        return $this->queryConnection($s_sql, $this->s_type_connection_write, $this->o_connection_write);
    }

	public function queryConnection($s_sql, &$s_type_connection, &$o_connection)
	{
