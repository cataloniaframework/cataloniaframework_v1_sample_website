...
<p>Introduced in Catalonia Framework v.1.1.014</p>
<h2>What is CQLSÍ</h2>
...
The pros:<br />
<ul>
    <li>As it uses the CQLSH DataStax client, it is compatible with the last versions of CQL.<br />
...
The cons:<br />
    <ul>
        ...
        <li>All the data is presented to you as String, that causes confusion with:<br />
